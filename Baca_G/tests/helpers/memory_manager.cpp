...
void memory_manager::deallocate(void* ptr) {
	...
	if(tracking_disabled == false) {
		...
		std::cerr << "[\033[0;91mMEM\033[0m] ! Invalid or double delete on pointer " << ptr << std::endl;
	}
