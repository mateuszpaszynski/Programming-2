...
string compute_result(int count, string numbers[]) {
	...
	switch(count) {
		case 2:
			Operation(result, Sum, 2, numbers[0].c_str(), numbers[1].c_str());
			break;
		case 3:
			Operation(result, Sum, 3, numbers[0].c_str(), numbers[1].c_str(), numbers[2].c_str());
			break;
		case 4:
			Operation(result, Sum, 4, numbers[0].c_str(), numbers[1].c_str(), numbers[2].c_str(), numbers[3].c_str());
			break;
		case 8:
			Operation(result, Sum, 8, numbers[0].c_str(), numbers[1].c_str(), numbers[2].c_str(), numbers[3].c_str(), numbers[4].c_str(), numbers[5].c_str(), numbers[6].c_str(), numbers[7].c_str());
			break;
	}
